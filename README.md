...
| NCAA Mens Games                    | ncaa_mens_games                           | Displays live NCAA Mens game scores, time remaining, etc. If the game hasn't started, start time is displayed. Can optionally display games for previous day as well.                                                  |
| NCAA Mens Favourite Team Next Game | ncaa_mens_fav_team_next_game              | Displays next game details for all specified favourite teams. If game is today, displays start time. Can optionally be suppressed if game is in progress. Will not display anything if no favourite team is set. |
| NCAA Womens Games                    | ncaa_womens_games                           | Displays live NCAA Womens game scores, time remaining, etc. If the game hasn't started, start time is displayed. Can optionally display games for previous day as well.                                                  |
| NCAA Womens Favourite Team Next Game | ncaa_womens_fav_team_next_game              | Displays next game details for all specified favourite teams. If game is today, displays start time. Can optionally be suppressed if game is in progress. Will not display anything if no favourite team is set. |
...
| MLS Games                    | mls_games                           | Displays live MLS game scores, time remaining, etc. If the game hasn't started, start time is displayed. Can optionally display games for previous day as well.                                                  |
...
| Premier League Games                    | epl_games                           | Displays live Premier League game scores, time remaining, etc. If the game hasn't started, start time is displayed. Can optionally display games for previous day as well.                                                  |
...
| La Liga Games                    | ll_games                           | Displays live La Liga game scores, time remaining, etc. If the game hasn't started, start time is displayed. Can optionally display games for previous day as well.                                                  |
...
| Bundesliga Games                    | bl_games                           | Displays live Bundesliga game scores, time remaining, etc. If the game hasn't started, start time is displayed. Can optionally display games for previous day as well.                                                  |
...
| Serie A Games                    | sa_games                           | Displays live Serie A game scores, time remaining, etc. If the game hasn't started, start time is displayed. Can optionally display games for previous day as well.                                                  |
...
| Ligue 1 Games                    | l1_games                           | Displays live Ligue 1 game scores, time remaining, etc. If the game hasn't started, start time is displayed. Can optionally display games for previous day as well.                                                  |
